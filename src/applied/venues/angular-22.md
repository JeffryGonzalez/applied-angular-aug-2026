...
_better_ inline than it does across files, and — the real reason — a component
...
Do not use @Service(), (@Injectable(...) is 'deprecated').
Manually provide services.

"Areas" should provide their own services.

Other "Areas" should use services available from other areas (because it breaks bundling)

Truly global services _Can_ use "@Service()", which means you don't need to provide it,
but putting it in app.config.ts in the provider's array seems better to me.
